...
public class ReservasView extends JFrame {
		...
		btnSiguiente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {		
					...
					Mensaje mensaje = new Mensaje("Por favor llenar todos los campos.", 1);
	...
	protected void calcularValor(JDateChooser txtFechaEntrada, JDateChooser txtFechaSalida) {
		String valorDia = "70000";
		if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
			if (txtFechaEntrada.getDate().compareTo(txtFechaSalida.getDate()) < 0) {
				double dias = calularDiasReservas(txtFechaEntrada.getDate(), txtFechaSalida.getDate());
				BigDecimal valor = new BigDecimal(dias * Double.valueOf(valorDia)).setScale(2);
				txtValor.setText(String.valueOf(valor));
			} else {
				txtValor.setText("Fecha no valida");
			}
		}
	}
	// Calcula los dias
	private double calularDiasReservas(Date fechaInicio, Date fechaFin) {
