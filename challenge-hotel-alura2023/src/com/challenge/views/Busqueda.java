...
public class Busqueda extends JFrame {
	...
	private void editarHuesped() {
		...
		.ifPresent(fila -> {
			...
			Mensaje mensaje = new Mensaje(String.format("%d item editado", filasModificadas), 1);
			mensaje.setVisible(true);
		});
	}
	// Eliminar Reserva
	private void eliminarReserva() {
		...
		.ifPresent(fila -> {
			...
			Mensaje mensaje = new Mensaje(String.format("%d item eliminado", cantidadEliminada), 1);
			mensaje.setVisible(true);
		});
	}
	// Eliminar Huesped
